export const ARTICLES = {
  root: [
    { id: 'open-low-e', cat: 'Instrument Physics', title: 'The Note That Breaks the Amp: the Open Low E', excerpt: 'Why a Strat neck pickup on the open sixth string sounds broken instead of saturated -- the missing fourth harmonic, magnet pull, and the screwdriver that fixes it.', link: '/open-low-e-strat', img: '/strato.png' },
    ...
    { id: 'evm12l', cat: 'Loudspeaker Physics', title: 'The Indestructible King: Electro-Voice EVM-12L', excerpt: 'The 300-Watt driver that defied fragile British paper cones. Why Keith Richards, SRV and Bonamassa swore by it.', link: '/electro-voice-evm12l', img: '/evm12L.png' },
  ...
  es: [
    { id: 'open-low-e', cat: 'Física del Instrumento', title: 'La nota que rompe el amplificador: el Mi grave al aire', excerpt: 'Por qué el micrófono del mango de una Strat en la sexta al aire suena roto y no saturado: el cuarto armónico que falta, el tirón del imán, y el destornillador que lo arregla.', link: '/es/mi-al-aire-strat', img: '/strato.png' },
    ...
    { id: 'evm12l', cat: 'Física del Altavoz', title: 'El Rey Indestructible: Electro-Voice EVM-12L', excerpt: 'El altavoz de 300 Watts que desafió a los conos británicos. Por qué Keith Richards, SRV y Bonamassa lo eligieron.', link: '/es/electro-voice-evm12l', img: '/evm12L.png' },
  ...
  ja: [
    { id: 'open-low-e', cat: '楽器の物理学', title: 'アンプを壊す音：開放6弦E', excerpt: 'ストラトのフロントピックアップで開放6弦を弾くと、なぜ歪みではなく壊れた音になるのか。消える第4倍音、磁石の引力、そしてそれを直すドライバー。', link: '/ja/open-low-e-strat', img: '/strato.png' },
    ...
    { id: 'evm12l', cat: '機材ヒストリー', title: '不滅のトーン・キング：Electro-Voice EVM-12L', excerpt: '薄型ペーパーコーンの常識を覆した300Wスピーカー。キース、SRV、ザック、ボナマッサが信頼した理由。', link: '/ja/electro-voice-evm12l', img: '/evm12L.png' },
