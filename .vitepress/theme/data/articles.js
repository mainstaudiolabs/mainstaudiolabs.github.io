export const ARTICLES = {
  root: [
    { id: 'open-low-e', cat: 'Instrument Physics', title: 'The Note That Breaks the Amp: the Open Low E', excerpt: 'Why a Strat neck pickup on the open sixth string sounds broken instead of saturated -- the missing fourth harmonic, magnet pull, and the screwdriver that fixes it.', link: '/open-low-e-strat' },
  ...
  es: [
    { id: 'open-low-e', cat: 'Física del Instrumento', title: 'La nota que rompe el amplificador: el Mi grave al aire', excerpt: 'Por qué el micrófono del mango de una Strat en la sexta al aire suena roto y no saturado: el cuarto armónico que falta, el tirón del imán, y el destornillador que lo arregla.', link: '/es/mi-al-aire-strat' },
  ...
  ja: [
    { id: 'open-low-e', cat: '楽器の物理学', title: 'アンプを壊す音：開放6弦E', excerpt: 'ストラトのフロントピックアップで開放6弦を弾くと、なぜ歪みではなく壊れた音になるのか。消える第4倍音、磁石の引力、そしてそれを直すドライバー。', link: '/ja/open-low-e-strat' },
