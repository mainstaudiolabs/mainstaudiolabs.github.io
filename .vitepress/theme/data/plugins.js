...
export const PLUGINS = {
  root: {
    'tattoo-you': {
      ...
      specs: ["12 neural 6L6 models (Clean / Crunch / Lead)", "1x12 EVM-12L cabinet with 24 mic takes", "Single-track Stereo Spread 3D", "Phase '78 + Slapback Delay", "5-band graphic EQ", "Built-in chromatic tuner", "Pay-what-you-want: 6s wait without a license"]
    },
    'midnight-rambler': {
  ...
  es: {
    'tattoo-you': {
      ...
      specs: ['12 modelos neurales 6L6 (Clean / Crunch / Lead)', 'Cabina 1x12 EVM-12L con 24 tomas de mic', 'Stereo Spread 3D en una sola pista', "Phase '78 + Slapback Delay", 'Ecualizador gráfico de 5 bandas', 'Afinador cromático integrado', 'Modelo a voluntad: espera de 6s sin licencia']
    },
    'midnight-rambler': {
  ...
  ja: {
    'tattoo-you': {
      ...
      specs: ['6L6ニューラルモデル12種（Clean / Crunch / Lead）', '24テイクの1x12 EVM-12Lキャビネット', '1トラック完結のStereo Spread 3D', "Phase '78 + スラップバックディレイ", '5バンド・グラフィックEQ', 'クロマチックチューナー内蔵', '寄付制モデル：ライセンス未登録時は起動時に6秒待機']
    },
    'midnight-rambler': {
