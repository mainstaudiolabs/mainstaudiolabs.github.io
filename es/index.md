...
<div class="rock-grid">
  ...
  <div class="rock-card">
    ...
    <div class="rock-card-content">
      ...
      <p class="rock-card-desc">Un simulador de amplificador en formato pedal impulsado por modelado neuronal (NAM) y basado en el legendario Tweed Deluxe 5E3. Creado para ofrecer ese tono de rock clásico, crudo y sensible al tacto de finales de los 60 y principios de los 70: desde el icónico crunch de Keith Richards en los Stones y los grasientos riffs de The Faces (Ron Wood), hasta el rugiente overdrive Tweed de Neil Young, la mordida texana de Billy Gibbons y el legendario tono de introducción de Ed King en <em>Sweet Home Alabama</em>. Cuenta con conmutación de dos canales (Edge of Breakup &amp; Cranked Overdrive), filtros de tono de alta precisión listos para mezcla, perfiles IR de gabinetes personalizados y latencia cercana a cero con una huella de CPU ultra baja.</p>
