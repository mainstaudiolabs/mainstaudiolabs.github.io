...
<div class="rock-grid">
  ...
  <div class="rock-card coming-soon">
    ...
    <div class="rock-card-content">
      ...
      <p class="rock-card-desc">The definitive 100W 6L6 tube amplifier simulation and Keith Richards signature vintage dual FX suite. Beast of Burden captures the iconic studio and arena Stones guitar tone — from chimey, dynamic compressed cleans and responsive 80's edge-of-breakup to roaring, mid-forward classic rock lead sustain. Featuring a 3-way channel selector (Clean, Crunch, Lead), authentic 5-Band Graphic Equalizer with the legendary Mesa V-curve, Phase '78 optical phaser (MXR Phase 100 style), 110ms analog tape slapback delay, and the punchy Pacific Woodworks 1x12 Electro-Voice EVM-12L cabinet simulation.</p>
      <div class="rock-card-actions">
