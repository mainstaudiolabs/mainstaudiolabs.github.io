...
<div class="rock-grid">
  ...
  <div class="rock-card coming-soon">
    ...
    <div class="rock-card-content">
      ...
      <p class="rock-card-desc">The definitive Mesa/Boogie Mark IIC+ (100W 6L6) amplifier emulation and Keith Richards signature vintage dual FX suite. Powered by deep neural networks (NAM) and ultra-fast convolution, Beast of Burden captures the iconic studio and arena Stones guitar tone — from chimey, dynamic compressed cleans and responsive 80's edge-of-breakup to roaring, mid-forward classic rock lead sustain. Featuring a 3-way channel selector (Clean, Crunch, Lead), authentic 5-Band Graphic Equalizer with the legendary Mesa V-curve, Phase '78 optical phaser (MXR Phase 100 style), 110ms analog tape slapback delay, and pure-phase studio impulse responses of the Pacific Woodworks 1x12 Electro-Voice EVM-12L speaker.</p>
      <div class="rock-card-actions">
