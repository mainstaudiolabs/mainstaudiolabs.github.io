...
<aside class="classic-sidebar">
  <div class="classic-sidebar-title">SECTIONS</div>
  <ul class="classic-nav-list">
    <li><a href="/manuals" class="classic-nav-link">📁 Plugins Manuals</a></li>
    <li><a href="/audio-and-mixing" class="classic-nav-link">🎛️ Audio &amp; Mixing</a></li>
    <li><a href="/backstage" class="classic-nav-link">🎸 Backstage</a></li>
    <li class="classic-nav-divider"></li>
    <li><a href="/about" class="classic-nav-link">ℹ️ About</a></li>
    <li><a href="/support" class="classic-nav-link">☕ Support the Lab</a></li>
  </ul>
</aside>
...
<p class="rock-card-desc">'78 Mark I circuit with 12 neural models (100W/60W, Normal/Bright), 1x12 Hardwood Cab Lab with 24 takes, single-track Stereo Spread 3D, Phase '78, Delay, and rack tuner.</p>
<div class="rock-card-footer">
<span class="rock-card-price" style="color: var(--vp-c-brand-1); font-weight: bold;">$14 USD / EVAL</span>
<a href="/tattoo-you" class="rock-btn rock-btn-primary" style="padding: 0.45rem 0.9rem; font-size: 0.84rem;">User Manual ➔</a>
</div>
</div>
</div>
...
<a href="/midnight-rambler" class="rock-btn rock-btn-primary" style="padding: 0.45rem 0.9rem; font-size: 0.84rem;">User Manual ➔</a>
</div>
</div>
</div>
...
<div class="rock-card-footer">
<span class="rock-card-price">FREE</span>
<a href="/tuner-pedal" class="rock-btn rock-btn-primary" style="padding: 0.45rem 0.9rem; font-size: 0.84rem;">User Manual ➔</a>
</div>
</div>
</div>
...
<div style="display: flex; justify-content: space-between; align-items: baseline; border-bottom: 2px solid var(--vp-c-border); padding-bottom: 0.5rem; margin-top: 2.5rem; margin-bottom: 1.25rem;">
  ...
  <a href="/audio-and-mixing" style="font-family: 'Courier Prime', monospace; font-size: 0.85rem; color: var(--vp-c-brand-1);">
    View Complete Index ➔
  </a>
</div>
...
<div style="background: var(--vp-c-bg-soft); border: 1px solid var(--vp-c-border); border-radius: 4px; padding: 1.25rem;">
  ...
  <p style="font-size: 0.85rem; color: var(--vp-c-text-2); margin: 0; line-height: 1.45;">
    EVM-12L driver physics, sample-accurate alignment at $t=0$, Left/Right takes, and single-track 3D stereo width.
  </p>
</div>

<!-- Article 2: EVM-12L Story -->
<div style="background: var(--vp-c-bg-soft); border: 1px solid var(--vp-c-border); border-radius: 4px; padding: 1.25rem;">
  <div style="font-size: 0.75rem; text-transform: uppercase; color: var(--vp-c-brand-1); font-weight: bold; margin-bottom: 0.35rem;">Loudspeaker Physics</div>
  <h4 style="margin: 0 0 0.5rem 0; font-size: 1.05rem;">
  ...
  <p style="font-size: 0.85rem; color: var(--vp-c-text-2); margin: 0; line-height: 1.45;">
    The 300-Watt driver that defied fragile British paper cones. Why Keith Richards, SRV and Bonamassa swore by it.
  </p>
</div>

<!-- Article 3: Stones & Mesa -->
<div style="background: var(--vp-c-bg-soft); border: 1px solid var(--vp-c-border); border-radius: 4px; padding: 1.25rem;">
  <div style="font-size: 0.75rem; text-transform: uppercase; color: var(--vp-c-brand-1); font-weight: bold; margin-bottom: 0.35rem;">Backstage &amp; Chronicles</div>
  <h4 style="margin: 0 0 0.5rem 0; font-size: 1.05rem;">
    <a href="/history-mesa-stones" style="color: var(--vp-c-text-1); text-decoration: none;">The Stones Don't Pay for Amps (1978–1981) →</a>
  </h4>
  <p style="font-size: 0.85rem; color: var(--vp-c-text-2); margin: 0; line-height: 1.45;">
    How Keith Richards adopted Mark I &amp; II amps during the Paris sessions for <em>Some Girls</em> and <em>Tattoo You</em>.
  </p>
</div>
...
We craft precision studio audio software with zero bloatware, no recurring subscriptions, and no invasive DRM. Reach out:
</p>
...
<a href="/support" class="rock-btn rock-btn-secondary" style="display: inline-block; padding: 0.45rem 1.1rem; font-size: 0.85rem;">
